...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.0, 297.0, 34.0, 19.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 263.0, 414.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 259.0, 389.0, 37.0, 19.0 ],
					"text" : "timer"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 634.0, 177.0, 78.0, 17.0 ],
									"text" : "loopinterp $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 658.0, 143.0, 119.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 166.0, 152.0, 79.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.0, 255.0, 36.0, 36.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.0, 383.0, 105.0, 31.0 ],
					"text" : "bang when finished processing"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 148.0, 343.0, 180.0, 21.0 ],
					"text" : "vb.freezer-thread~ uhu 400"
				}
